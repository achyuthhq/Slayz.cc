...
const Features = () => {
  ...
  <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
    Build smarter bios with AI-enhanced customization, analytics, and seamless integrations — designed to stand out in the digital crowd.
  </p>
</div>
            </Container>
