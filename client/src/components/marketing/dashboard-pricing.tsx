    ...
    >
      ...
      <div className="flex flex-col items-start w-full px-4 py-2 md:px-8">
        <Button
          className={cn(
            "w-full",
            plan.title === "Sovereign" ? "bg-primary hover:bg-primary/90" : "bg-secondary hover:bg-secondary/90"
          )}
          onClick={() => {
      ...
      <div className="flex flex-col items-start w-full p-5 mb-4 ml-1 gap-y-3">
        <span className="text-base text-left mb-2 font-medium">Includes:</span>
...
// This component is specifically for use in the dashboard
        ...
        <>
          <div className="mx-auto max-w-3xl text-center mb-10">
            ...
            <p className="mt-4 text-xl text-muted-foreground">
              Thank you for being a premium member! Here are your subscription
              details.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto mb-20">
            <Card className="border-primary bg-gradient-to-br from-black/40 to-primary/5">
              <CardHeader>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <CardTitle className="text-2xl">Sovereign Plan</CardTitle>
                    <CardDescription>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="bg-black/10 rounded-lg p-6 border border-primary/20">
                  ...
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-4">
                    <li className="flex items-center">
                      ...
                      <span className="text-sm">Advanced profile customization</span>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-3 h-5 w-5 flex-shrink-0 rounded-full bg-gradient-to-r from-primary to-violet-500 flex items-center justify-center">
                        <Check className="h-3 w-3 text-white" />
                      </div>
                      <span className="text-sm">Unlimited social links</span>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-3 h-5 w-5 flex-shrink-0 rounded-full bg-gradient-to-r from-primary to-violet-500 flex items-center justify-center">
                        <Check className="h-3 w-3 text-white" />
                      </div>
                      <span className="text-sm">Premium themes and layouts</span>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-3 h-5 w-5 flex-shrink-0 rounded-full bg-gradient-to-r from-primary to-violet-500 flex items-center justify-center">
                        <Check className="h-3 w-3 text-white" />
                      </div>
                      <span className="text-sm">Steam integration</span>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-3 h-5 w-5 flex-shrink-0 rounded-full bg-gradient-to-r from-primary to-violet-500 flex items-center justify-center">
                        <Check className="h-3 w-3 text-white" />
                      </div>
                      <span className="text-sm">Profile decorations</span>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-3 h-5 w-5 flex-shrink-0 rounded-full bg-gradient-to-r from-primary to-violet-500 flex items-center justify-center">
                        <Check className="h-3 w-3 text-white" />
                      </div>
                      <span className="text-sm">Display name effects</span>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-3 h-5 w-5 flex-shrink-0 rounded-full bg-gradient-to-r from-primary to-violet-500 flex items-center justify-center">
                        <Check className="h-3 w-3 text-white" />
                      </div>
                      <span className="text-sm">Profile particle effects</span>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-3 h-5 w-5 flex-shrink-0 rounded-full bg-gradient-to-r from-primary to-violet-500 flex items-center justify-center">
                        <Check className="h-3 w-3 text-white" />
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-sm">Unlimited chatbot with custom prompts</span>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-3 h-5 w-5 flex-shrink-0 rounded-full bg-gradient-to-r from-primary to-violet-500 flex items-center justify-center">
                        <Check className="h-3 w-3 text-white" />
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-sm">Exclusive premium badges</span>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-3 h-5 w-5 flex-shrink-0 rounded-full bg-gradient-to-r from-primary to-violet-500 flex items-center justify-center">
                        <Check className="h-3 w-3 text-white" />
                      </div>
                      <span className="text-sm">AI-powered profile optimization</span>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-3 h-5 w-5 flex-shrink-0 rounded-full bg-gradient-to-r from-primary to-violet-500 flex items-center justify-center">
                        <Check className="h-3 w-3 text-white" />
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-sm">Priority indexing on Slayz</span>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-3 h-5 w-5 flex-shrink-0 rounded-full bg-gradient-to-r from-primary to-violet-500 flex items-center justify-center">
                        <Check className="h-3 w-3 text-white" />
                      </div>
                      <span className="text-sm">Enhanced conversion tools</span>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-3 h-5 w-5 flex-shrink-0 rounded-full bg-gradient-to-r from-primary to-violet-500 flex items-center justify-center">
                        <Check className="h-3 w-3 text-white" />
                ...
                <div className="bg-black/20 rounded-lg border border-white/10 p-4">
                  ...
                  <p className="text-muted-foreground text-sm mb-4">
                    You have lifetime access to all premium features. No
                    renewal required!
                  </p>
            ...
            <tbody className="divide-y divide-border">
              {featureComparisonData.map((row, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm bg-primary-foreground/30">
                    {row.pro === "✅" ? (
